#!/usr/bin/env sh
# Universal installer for fwxray. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/fwxray.git"
echo "Installing fwxray ..."
