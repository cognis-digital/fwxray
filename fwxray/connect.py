"""Native cognis-connect emit for fwxray — forward findings to any platform.

Maps fwxray's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    fwxray ... --format json | fwxray-emit --to stix
    fwxray-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
